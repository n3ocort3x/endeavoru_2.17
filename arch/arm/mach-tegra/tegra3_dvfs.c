...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("cpu_lp", lp_cpu_millivolts, 0, 1, KHZ,   100000, 150000, 200000, 250000, 300000,  400000,  400000,  500000),
	CORE_DVFS("cpu_lp", lp_cpu_millivolts, 1, 1, KHZ,   150000, 200000, 250000, 300000, 400000,  400000,  400000,  500000),
	CORE_DVFS("cpu_lp", lp_cpu_millivolts, 2, 1, KHZ,   150000, 250000, 300000, 400000, 400000,  400000,  400000,  500000),
	CORE_DVFS("cpu_lp", lp_cpu_millivolts, 3, 1, KHZ,   100000, 100000, 100000, 100000, 100000,  100000,  400000,  500000),
	...
	CORE_DVFS("vde", avp_millivolts, 1, 1, KHZ,        1, 247000, 304000, 400000, 416000,  484000,  484000,  484000),
	CORE_DVFS("mpe", avp_millivolts, 1, 1, KHZ,        1, 247000, 304000, 400000, 416000,  484000,  484000,  484000),
	CORE_DVFS("2d", avp_millivolts, 1, 1, KHZ,        1, 247000, 304000, 400000, 416000,  484000,  484000,  484000),
	CORE_DVFS("epp", avp_millivolts, 1, 1, KHZ,        1, 247000, 304000, 400000, 416000,  484000,  484000,  484000),
	CORE_DVFS("3d", avp_millivolts, 1, 1, KHZ,        1, 247000, 304000, 400000, 416000,  484000,  484000,  484000),
	CORE_DVFS("3d2", avp_millivolts, 1, 1, KHZ,        1, 247000, 304000, 400000, 416000,  484000,  484000,  484000),
	CORE_DVFS("se", avp_millivolts, 1, 1, KHZ,        1, 247000, 304000, 400000, 416000,  484000,  484000,  484000),
#else
...
#ifdef CONFIG_TEGRA_3D_GPU_OVERCLOCK
	CORE_DVFS("cbus", avp_millivolts, 0, 1, KHZ,        1, 247000, 304000, 400000, 416000,  484000,  484000,  484000),
	CORE_DVFS("cbus", avp_millivolts, 1, 1, KHZ,        1, 247000, 304000, 400000, 416000,  484000,  484000,  484000),
#else
...
#endif
	CORE_DVFS("cbus", avp_millivolts, 2, 1, KHZ,        1, 247000, 304000, 352000, 400000,  416000,  437000,  484000),
